...
file_name='dummy'
coordinate_data_set = "D:/coordi_test.csv"
FILE = open(coordinate_data_set,"a")
root= Tk()
fileCounter = 0
coor1 = ""
coor2 = ""
...
def nextIMG(event):
	...
	if fileCounter<total_files :
		...
		load_res = load.resize((640,480))
		file_name=files[fileCounter]
		fileCounter=fileCounter+1
		photo = ImageTk.PhotoImage(load_res)
...
def rightClick(event):
	...
	global file_name
	global FILE
	coordinate_data_set = "D:/coordi_train.csv"
	FILE = open(coordinate_data_set,"a")
