...
class Network:
    ...
    def feature_extraction(self):
        ...
        initial_epochs = 10
        self.loss0, self.accuracy0 = self.model.evaluate(self.validation_dataset)
    ...
    def FT_unfreeze_top_layers(self):
    ...
    def FT_train(self):
        ...
        self.loss_fine, self.accuracy_fine = self.model.evaluate(self.test_dataset)
        print('Test accuracy :', self.accuracy_fine)
